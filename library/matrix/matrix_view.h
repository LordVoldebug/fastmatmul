...
// наоборот.
// И так проще, как минимум меньше методов прокидывать, да и в целом имхо так
// логичнее
...
class MaybeTransposedMatrixView {
 public:
  ...
  // удовольствие чтобы компилятор мог выбрать и не было ambiguity, а так
  // читаемо и у этого есть понятный физический смысл: такие касты разрешены
