...
using MatrixElementType = typename MatrixElementTypeImpl<std::remove_cvref_t<MatrixLike>>::Type
;
...
template<typename T>
concept MutableMatrixOrViewType = kIsMutableMatrixOrViewType<std::remove_cvref_t<T>>;
